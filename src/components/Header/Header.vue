...
<template>
    <div id="navpage" :class="[iconopen ? 'open' : 'close']">
        <div class = "nav1" v-for="route in routes" v-bind:key="route.path">
            <router-link :to="route.to" v-text="route.path"></router-link> 
        </div>
    </div>
    <div id="nav">
        <div class = "leftnav" :class="[!iconopen ? 'leftnav' : 'close']"> 
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 433.6 97.1" style="enable-background:new 0 0 433.6 97.1; width: 150px;" xml:space="preserve">
                    <g>
                    <g>
                    ...
                    <g>
                        ...
                        <path class="st0" d="M1.9,48.5c0-25.7,20.9-46.6,46.6-46.6s46.6,20.9,46.6,46.6S74.3,95.2,48.5,95.2S1.9,74.2,1.9,48.5 M0,48.5 C0,75.3,21.8,97,48.5,97S97,75.2,97,48.5S75.3,0,48.5,0S0,21.8,0,48.5"></path>
        ...
        <div class = "rightnav">
            <div class = "rightnav1" v-for="route in routes" v-bind:key="route.path" :class="[!iconopen ? 'rightnav1' : 'close']">
                <router-link :to="route.to" v-text="route.path"></router-link> 
            </div>
            <div class = "rightnav2">
                <button class="icon" @click="iconopen=!(iconopen)">☰</button>
            </div>
        </div>
    </div>
</template>
