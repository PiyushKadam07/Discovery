    ...
    <div class="footer-div">
        <footer>
            <div class="footer-content">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 359 360" style="enable-background:new 0 0 359 360;" xml:space="preserve">
                    <g>
                        <path class="st0"
                        ...
                        <g>
                            ...
                            <path class="st0" d="M56,237c-0.9,0.4-1.9-0.1-2.2-0.9c-0.3-0.9,0.1-1.9,1-2.2s2,0,2.3,0.9C57.4,235.6,56.9,236.6,56,237"></path>
                            <path class="st0" d="M66.5,232.8c-0.9,0.4-1.9-0.1-2.2-0.9c-0.3-0.9,0.1-1.9,1-2.2s2,0,2.3,0.9C67.9,231.4,67.4,232.4,66.5,232.8"></path>
                            <path class="st0" d="M77.2,228.5c-0.9,0.3-1.9-0.1-2.2-0.9c-0.3-0.9,0.1-1.9,1-2.2s2,0,2.3,0.9C78.6,227.1,78.1,228.1,77.2,228.5"></path>
                        ...
                        <g>
                            ...
                            <path class="st0" d="M84.7,139.7c-0.9-0.4-1.3-1.4-1-2.2c0.3-0.9,1.4-1.2,2.3-0.9s1.4,1.4,1,2.3C86.7,139.7,85.7,140.1,84.7,139.7"></path>
                        ...
                        <g>
                            ...
                            <path class="st0" d="M239,45c-0.4,0.9-1.4,1.3-2.2,1c-0.9-0.3-1.2-1.4-0.9-2.3c0.4-0.9,1.4-1.4,2.3-1C239,43,239.4,44.1,239,45"></path>
                        </g>
                        <g>
                            ...
                            <path class="st0" d="M149,119.8c0.4,0.9,1.4,1.3,2.2,1c0.9-0.3,1.2-1.4,0.9-2.3s-1.4-1.4-2.3-1C149,117.9,148.6,118.9,149,119.8"></path>
                        ...
                        <g>
                            ...
                            <path class="st0" d="M240,207.6c0.9,0.4,1.3,1.4,1,2.2c-0.3,0.9-1.4,1.2-2.3,0.9s-1.4-1.4-1-2.3C238,207.5,239.1,207.2,240,207.6"></path>
                        ...
                        <path class="st0" d="M18.2,180c0-88.9,72.4-161.3,161.3-161.3S340.9,91.1,340.9,180s-72.4,161.3-161.3,161.3S18.2,268.9,18.2,180
                        M11.6,180c0,92.6,75.3,167.9,167.9,167.9S347.4,272.6,347.4,180S272.1,12.1,179.5,12.1S11.6,87.4,11.6,180"></path>

                        <rect x="266.7" y="239.4" transform="matrix(0.7071 -0.7072 0.7072 0.7071 -112.1272 268.0646)" class="st0" width="1.6" height="60"></rect>
